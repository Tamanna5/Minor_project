...
class Exp_Short_Term_Forecast(Exp_Basic):
    ...
    def _build_model(self):
        if self.args.data == 'm4':
            # Allow custom prediction length if specified, otherwise use default from M4Meta
            if not hasattr(self.args, 'custom_pred_len') or self.args.custom_pred_len is None:
